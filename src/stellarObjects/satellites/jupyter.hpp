...
struct CallistoProgram : public AStellarObject {
    float coef_diametre = 0.0241;
    float dist_jupyter = 0.06721428571 + DISTANCE_SATELLITE;
...
struct GanymedeProgram : public AStellarObject {
    float coef_diametre = 0.026312;
    float dist_jupyter = 0.03822857143 + DISTANCE_SATELLITE;
    glm::vec3 sattelites_rotation_axis = glm::vec3(0, 1, 0); //glm::sphericalRand(1.f);
    glm::vec3 sattelites_initial_position = glm::vec3(dist_jupyter, 0, 0); //glm::sphericalRand(2.f);
...
struct EuropaProgram : public AStellarObject {
    float coef_diametre = 0.015608;
    float dist_jupyter = 0.02396785714 + DISTANCE_SATELLITE;
    glm::vec3 sattelites_rotation_axis = glm::vec3(0, 1, 0); //glm::sphericalRand(1.f);
    glm::vec3 sattelites_initial_position = glm::vec3(dist_jupyter, 0, 0); //glm::sphericalRand(2.f);
...
struct IOProgram : public AStellarObject {
    float coef_diametre = 0.018215;
    float dist_jupyter = 0.01506428571 + DISTANCE_SATELLITE;
    glm::vec3 sattelites_rotation_axis = glm::vec3(0, 1, 0); //glm::sphericalRand(1.f);
    glm::vec3 sattelites_initial_position = glm::vec3(dist_jupyter, 0, 0); //glm::sphericalRand(2.f);
